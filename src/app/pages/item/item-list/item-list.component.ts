...
export class ItemListComponent implements OnInit {
  ...
  columns = [
    ...
    { columnDef: 'CostPrice', header: 'Preço Custo', cell: (element: any) => `${element.costPrice} €` },
    { columnDef: 'Margin', header: 'Margem ', cell: (element: any) => `${element.margin} %` },
    { columnDef: 'SellingPrice', header: 'Preço Venda', cell: (element: any) => `${element.sellingPrice} €` },
